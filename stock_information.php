...
$colom_name[0]='No';
$colom_name[1]='Barcode';
$colom_name[2]='Nama Barang';
$colom_name[3]='Qty Barang';
$colom_name[4]='Input Date';
$colom_name[5]='Modal';
$colom_name[6]='Harga Jual';


$insert_text="'','','','{$today}','','','{$t_login_user_access}'";

$colom_name_sql[0]='id';
$colom_name_sql[1]='id_barcode';
$colom_name_sql[2]='id_name';
$colom_name_sql[3]='qty';
$colom_name_sql[4]='input_date';
$colom_name_sql[5]='buy_price';
$colom_name_sql[6]='sell_price';

$total_data_in_one_page = 5;
$DB_TABLE_NAME = 'heroku_dfb97b98a1fad88.t_t_stock';
